...
return [
    ...
    'approve_docs' => 'Подтверждающие документы',
    'license' => 'Лицензия',
    'add_doc' => 'Доп.документ',
    'about_me' => 'О себе:',
    ...
    'trainer' => 'Тренер:',
    'trainer_is_not_defined' => 'Тренер не определен',
    'site' => 'Сайт:',
    ...
    'add_section' => 'Добавить спортивную секицю:',
    ...
    'back_main_page' => 'Вернуться на главную',
    'logout' => 'Выйти',
    ...
    'trainer_request' => 'Тренерская заявка',
    ...
    'triple_block_text1' => 'Найти тренера для занятий спортом',
    'triple_block_text2' => 'Запишитесь на тренировку по видам спорта и площадкам',
    'triple_block_text3' => 'Узнайте, какой вид спорта вам подходит',
