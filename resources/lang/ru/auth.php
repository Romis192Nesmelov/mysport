...
return [
    ...
    */
    ...
    'unsubscribe' => 'Вы отписались от автоматической рассылки!',
    'you_have_no_rights' => 'У вас нет прав для совершения данной операции!',

    'confirmed_account' => 'Аккаунт подтвержден',
    'confirmed_not_account' => 'Аккаунт не подтвержден',
    'phone' => 'Телефон',
    'email' => 'E-Mail',
